...
public class StudentAnalyzerTest {
    ...
    @Test
    public void testCountExcellentStudents_NormalList() {
    ...
    public void testCountExcellentStudents_MixedValues() {
        ...
        assertEquals(1,
                analyzer.countExcellentStudents(
                        Arrays.asList(10.0, 0.0, 7.5)));
    }

    @Test
    public void testCalculateValidAverage_NormalList() {
        StudentAnalyzer analyzer = new StudentAnalyzer();
        assertEquals(8.17,
    ...
    @Test
    public void testCalculateValidAverage_BorderValues() {
        StudentAnalyzer analyzer = new StudentAnalyzer();
        assertEquals(5.0,
                analyzer.calculateValidAverage(
